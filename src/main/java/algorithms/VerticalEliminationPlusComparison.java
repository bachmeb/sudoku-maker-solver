...
public class VerticalEliminationPlusComparison extends SudokuAlgorithm {
    ...
    public String explanation() {
        return """
                Vertical elimination plus comparison.
                ...
                open squares in the same inner column of the same box with values in other
                boxes in the same rows.
                """;
    }
